...
const images = [
  '/image/random6.jpg', '/image/random7.jpg', '/image/random8.jpg',
  '/image/random9.jpg',  '/image/random3.jpg'
];
  ...
  return `
    <div class="card shadow" style="position: relative;">
      ...
      <div class="icon-container">
        <button class="icon-button heart" onclick="toggleIcon(this)">
          <img src="icon/heart-fill.svg">
        </button>
        <button class="icon-button bookmark" onclick="toggleIcon(this)">
